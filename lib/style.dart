...
class Style {
  ...
  static Map<String, Style> fromThemeData(ThemeData theme) => {
        'h1': Style.fromTextStyle(theme.textTheme.headlineSmall!),
        'h2': Style.fromTextStyle(theme.textTheme.headlineSmall!),
        'h3': Style.fromTextStyle(theme.textTheme.headlineMedium!),
        'h4': Style.fromTextStyle(theme.textTheme.headlineMedium!),
        'h5': Style.fromTextStyle(theme.textTheme.headlineLarge!),
        'h6': Style.fromTextStyle(theme.textTheme.headlineLarge!),
